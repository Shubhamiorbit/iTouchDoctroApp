...
import Pages.OTPClass;
import io.appium.java_client.HidesKeyboard;

public class OTPTest extends BaseClassDoctor {
	...
	public void enterOTPTest() throws Exception {
		String otp = OTPClass.fetchLatestOTP();
		Assert.assertNotNull(otp, "OTP should not be null");
		test.log(Status.INFO, "Waiting for OTP input fields....");
		
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		List<WebElement> otpfields = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup/android.widget.EditText")));
